...
import com.developerali.bongbilling.SearchActivity;
import com.developerali.bongbilling.databinding.FragmentTodayBinding;
...
public class TodayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchKeyword = dateFormat.format(new Date());
